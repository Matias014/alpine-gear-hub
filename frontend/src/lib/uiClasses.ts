...
export const buttonDanger =
  'inline-flex items-center justify-center rounded-lg bg-red-600 px-5 py-2.5 text-sm font-semibold ' +
  'text-white shadow-sm transition-colors hover:bg-red-500 disabled:opacity-50'
